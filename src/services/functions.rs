...
impl Functions {  
    ...
    pub fn get(&self, function_id: &str) -> Result<reqwest::blocking::Response, AppwriteException> {
    ...
    pub fn delete(&self, function_id: &str) -> Result<reqwest::blocking::Response, AppwriteException> {
        let path = "/functions/functionId".replace("functionId", &function_id);
    ...
    pub fn get_execution(&self, function_id: &str, execution_id: &str) -> Result<reqwest::blocking::Response, AppwriteException> {
    ...
    /// endpoint.
    pub fn update_tag(&self, function_id: &str, tag: &str) -> Result<reqwest::blocking::Response, AppwriteException> {
    ...
    pub fn create_tag(&self, function_id: &str, command: &str, code: std::path::PathBuf) -> Result<reqwest::blocking::Response, AppwriteException> {
        let path = "/functions/functionId/tags".replace("functionId", &function_id);
    ...
    pub fn get_tag(&self, function_id: &str, tag_id: &str) -> Result<reqwest::blocking::Response, AppwriteException> {
    ...
    pub fn delete_tag(&self, function_id: &str, tag_id: &str) -> Result<reqwest::blocking::Response, AppwriteException> {
        let path = "/functions/functionId/tags/tagId".replace("functionId", &function_id).replace("tagId", &tag_id);
