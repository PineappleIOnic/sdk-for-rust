...
impl Display for Webhook {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatBuffer.push_str(&format!("{:?}", self.security));
...
impl Webhook {
    pub fn new(id: String, name: String, url: String, events: Vec<String>, security: bool, httpUser: String, httpPass: String, ) -> Self {
        Self {
            id: id,
            name: name,
            url: url,
